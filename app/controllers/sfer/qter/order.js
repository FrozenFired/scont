...
exports.ordersFilter = function(req, res, next) {
	...
	if(req.query && req.query.keytype == "sfer"){
		...
		condition.symPul = "$eq";
		condition.condPul = req.query.keyword;
		qtOrderFindVders(req, res, next, condition);
	} else {
		condition.symPul = '$ne';
...
exports.orders = function(req, res) {
	...
	res.render('./sfer/qter/order/list', list)
}
...
exports.orderAdd =function(req, res) {
	res.render('./sfer/qter/order/add', {
		title: 'Add Order',
...
exports.order = function(req, res) {
	...
	res.render('./sfer/qter/order/detail', {
		title: 'qtOrder Infomation',
		crSfer : req.session.crSfer,
		object: objBody,
		today: today,
		weekday: weekday
