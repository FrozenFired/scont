...
exports.paysFilter = function(req, res, next) {
	...
	if(req.query && req.query.keytype == "vder"){			// 如果是查找供应商 则先进入供应商数据库
		...
		qtPayFindPays(req, res, next, condition);
	}
}
qtPayFindVder = function(req, res, next, condition) {
...
qtPayFindOrders = function(req, res, next, condition) {
...
qtPayFindPays = function(req, res, next, condition) {
	Pay.count({
...
exports.pays = function(req, res) {
	...
	res.render('./sfer/qter/pay/list', list)
}
