...
exports.tasks = function(req, res) {
	res.render('./sfer/qter/task/list', req.body.list)
}


exports.tasksPrint = function(req, res) {
...
exports.taskAdd =function(req, res) {
	...
	.exec(function(err, objects) {
		...
		let code = qtNewTaskCode(objects[0], req.session.crSfer.code)

		res.render('./sfer/qter/task/add', {
			title: 'Add Task',
...
qtNewTaskCode = function(lastTask, userCode) {
...
exports.qtTaskNew = function(req, res) {
...
exports.task = function(req, res) {
	...
	res.render('./sfer/qter/task/detail', {
...
exports.taskUp = function(req, res) {
	let objBody = req.body.object

	res.render('./sfer/qter/task/update', {
		title: 'task Update',
		crSfer : req.session.crSfer,
		object: objBody
	})
...
exports.taskUpd = function(req, res) {
	let objBody = req.body.object
	// console.log(objBody)
