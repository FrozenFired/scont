...
exports.sconts = function(req, res) {
	res.render('./sfer/qter/scont/list', req.body.list)
}
...
exports.scontAdd = function(req, res) {
	Nation.find(function(err, nations) {
		if(err) console.log(err);
		res.render('./sfer/qter/scont/add', {
			title: 'Discount Add',
...
exports.addScont = function(req, res) {
	qtCreateBrand(req, res);
}
qtCreateBrand = function(req, res) {
		...
		.exec(function(err, sconts) {
			...
			if(sconts.length > 0) {
				...
				_object.save(function(err, objSave) {
					...
					res.redirect('/qtScont/' + objSave._id)
				})
			}
		})
	}
...
exports.scont = function(req, res){
	...
	res.render('./sfer/qter/scont/detail', {
