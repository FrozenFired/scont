...
exports.paysFilter = function(req, res, next) {
	...
	if(req.query && req.query.keytype == "vder"){			// 如果是查找供应商 则先进入供应商数据库
		...
		sfPayFindVder(req, res, next, condition);
	} 
		...
		condition.condPul = req.query.keyword;
		sfPayFindOrders(req, res, next, condition);
	}
		...
		sfPayFindPays(req, res, next, condition);
	}
}
sfPayFindVder = function(req, res, next, condition) {
...
sfPayFindOrders = function(req, res, next, condition) {
...
sfPayFindPays = function(req, res, next, condition) {
	Pay.count({
...
exports.pays = function(req, res) {
	...
	res.render('./sfer/sfer/pay/list', list)
}
...
exports.pay = function(req, res) {
	...
	list.title = "sfPay Infomation";

	res.render('./sfer/sfer/pay/detail', list)
}
