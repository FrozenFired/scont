...
exports.bcategs = function(req, res) {
	...
	res.render('./sfer/sfer/bcateg/list', {
		title: 'Bcateg List',
...
exports.bcateg = function(req, res){
	...
	.exec(function(err, brands) {
		...
		res.render('./sfer/sfer/bcateg/detail', {
...
exports.bcategPrint = function(req, res) {
	...
	.exec(function(err, brands) {
		...
		sfBcategPrintFunc(req, res, object, brands);
	})
}
sfBcategPrintFunc = function(req, res, object, brands) {
	let xl = require('excel4node');
	let wb = new xl.Workbook({
		defaultFont: {
			size: 12,
