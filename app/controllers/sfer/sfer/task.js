...
exports.tasks = function(req, res) {
	res.render('./sfer/sfer/task/list', req.body.list)
}
...
exports.taskAdd =function(req, res) {
	...
	.exec(function(err, objects) {
		...
		let code = sfNewTaskCode(objects[0], req.session.crSfer.code)

		res.render('./sfer/sfer/task/add', {
			title: 'Add Task',
...
sfNewTaskCode = function(lastTask, userCode) {
...
exports.task = function(req, res) {
	...
	res.render('./sfer/sfer/task/detail', {
...
exports.taskUp = function(req, res) {
	...
	res.render('./sfer/sfer/task/update', {
		title: 'task Update',
		crSfer : req.session.crSfer,
		object: objBody
	})
