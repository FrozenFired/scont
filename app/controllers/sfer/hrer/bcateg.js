...
exports.bcategs = function(req, res) {
	...
	res.render('./sfer/hrer/bcateg/list', {
		title: 'Bcateg List',
...
exports.bcateg = function(req, res){
	...
	.exec(function(err, brands) {
		...
		res.render('./sfer/hrer/bcateg/detail', {
...
exports.bcategPrint = function(req, res) {
	...
	.exec(function(err, brands) {
		...
		hrBcategPrintFunc(req, res, object, brands);
	})
}
hrBcategPrintFunc = function(req, res, object, brands) {
	let xl = require('excel4node');
	let wb = new xl.Workbook({
		defaultFont: {
			size: 12,
