...
exports.vendors = function(req, res) {
	res.render('./sfer/bner/vendor/list', req.body.list)
}
exports.vendorsPrint = function(req, res) {
...
exports.vendor = function(req, res){
	...
	res.render('./sfer/bner/vendor/detail', {
...
exports.vendorUp = function(req, res){
	let object = req.body.object;
	res.render('./sfer/bner/vendor/update', {
...
exports.vendorUpd = function(req, res) {
			...
			.exec(function(err, objects) {
				...
				if(objects.length > 0){
					...
					_object.save(function(err, objSave) {
						if(err) console.log(err);
						res.redirect('/bnVendor/'+objSave._id)
					})
				}
			})
		} else {
...
exports.vendorAdd = function(req, res) {
	res.render('./sfer/bner/vendor/add', {
		title: 'Vendor Add',
		crSfer: req.session.crSfer,
	})
}
...
exports.vendorNew = function(req, res) {
	let objBody = req.body.object
