...
exports.bcategs = function(req, res) {
	...
	res.render('./sfer/bner/bcateg/list', {
		title: 'Bcateg List',
...
exports.bcateg = function(req, res){
	...
	.exec(function(err, brands) {
		...
		res.render('./sfer/bner/bcateg/detail', {
...
exports.bcategPrint = function(req, res) {
	...
	.exec(function(err, brands) {
		...
		bnBcategPrintFunc(req, res, object, brands);
	})
}
bnBcategPrintFunc = function(req, res, object, brands) {
	let xl = require('excel4node');
	let wb = new xl.Workbook({
		defaultFont: {
			size: 12,
...
exports.bcategUp = function(req, res){
	let object = req.body.object;
	res.render('./sfer/bner/bcateg/update', {
...
exports.bcategUpd = function(req, res) {
			...
			.exec(function(err, objects) {
				...
				if(objects.length > 0){
					...
					_object.save(function(err, objSave) {
						if(err) console.log(err);
						res.redirect('/bnBcateg/'+objSave._id);
					})
				}
			})
		} else {
...
exports.bcategAdd = function(req, res) {
	res.render('./sfer/bner/bcateg/add', {
		title: 'BcategAdd',
		crSfer: req.session.crSfer,
	})
}
...
exports.bcategNew = function(req, res) {
	let objBody = req.body.object
