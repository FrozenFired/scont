...
exports.sconts = function(req, res) {
	res.render('./sfer/bner/scont/list', req.body.list)
}

exports.scontsPrint = function(req, res) {
...
exports.scontUp = function(req, res){
	// scontSingleFilter
	...
	res.render('./sfer/bner/scont/update', {
...
exports.scontUpd = function(req, res) {
...
exports.scontAdd = function(req, res) {
	Nation.find(function(err, nations) {
		if(err) console.log(err);
		res.render('./sfer/bner/scont/add', {
			title: 'Discount Add',
			crSfer: req.session.crSfer,
			nations: nations,
		})
...
exports.scontNew = function(req, res) {
	bnCreateBrand(req, res);
}
bnCreateBrand = function(req, res) {
	...
	if(req.body.object && req.body.object.brand){
		if(req.body.object.brand.length > 15) {
			...
			brandBody.creater = brandBody.updater = req.session.crSfer._id;
...
bnCreateVendor = function(req, res) {
	if(req.body.object && req.body.object.vendor){
		if(req.body.object.vendor.length > 15) {
			...
			vendorBody.creater = vendorBody.updater = req.session.crSfer._id;
...
bnCreateScont = function(req, res) {
	let objBody = req.body.object
		...
		.exec(function(err, sconts) {
			...
			if(sconts.length > 0) {
				...
				_object.save(function(err, objSave) {
					...
					res.redirect('/bnScont/' + objSave._id)
				})
			}
		})
	}
...
exports.scont = function(req, res){
	// scontSingleFilter
	let object = req.body.object
	res.render('./sfer/bner/scont/detail', {
