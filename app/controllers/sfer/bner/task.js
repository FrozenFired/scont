...
exports.tasks = function(req, res) {
	res.render('./sfer/bner/task/list', req.body.list)
}
...
exports.taskAdd =function(req, res) {
	...
	.exec(function(err, objects) {
		...
		let code = bnNewTaskCode(objects[0], req.session.crSfer.code)

		res.render('./sfer/bner/task/add', {
			title: 'Add Task',
...
bnNewTaskCode = function(lastTask, userCode) {
...
exports.task = function(req, res) {
	...
	res.render('./sfer/bner/task/detail', {
...
exports.taskUp = function(req, res) {
	...
	res.render('./sfer/bner/task/update', {
		title: 'task Update',
		crSfer : req.session.crSfer,
		object: objBody
	})
