...
exports.paysFilter = function(req, res, next) {
	...
	if(req.query && req.query.keytype == "vder"){			// 如果是查找供应商 则先进入供应商数据库
		...
		bnPayFindVder(req, res, next, condition);
	} 
		...
		condition.condPul = req.query.keyword;
		bnPayFindOrders(req, res, next, condition);
	}
		...
		bnPayFindPays(req, res, next, condition);
	}
}
bnPayFindVder = function(req, res, next, condition) {
...
bnPayFindOrders = function(req, res, next, condition) {
...
bnPayFindPays = function(req, res, next, condition) {
	Pay.count({
...
exports.pays = function(req, res) {
	...
	res.render('./sfer/bner/pay/list', list)
}
...
exports.pay = function(req, res) {
	...
	list.title = "bnPay Infomation";

	res.render('./sfer/bner/pay/detail', list)
}
