...
exports.bcategs = function(req, res) {
	...
	res.render('./sfer/lger/bcateg/list', {
		title: 'Bcateg List',
...
exports.bcateg = function(req, res){
	...
	.exec(function(err, brands) {
		...
		res.render('./sfer/lger/bcateg/detail', {
...
exports.bcategPrint = function(req, res) {
	...
	.exec(function(err, brands) {
		...
		lgBcategPrintFunc(req, res, object, brands);
	})
}
lgBcategPrintFunc = function(req, res, object, brands) {
	let xl = require('excel4node');
	let wb = new xl.Workbook({
		defaultFont: {
			size: 12,
