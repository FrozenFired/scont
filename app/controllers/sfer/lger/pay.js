...
exports.paysFilter = function(req, res, next) {
	...
	if(req.query && req.query.keytype == "vder"){			// 如果是查找供应商 则先进入供应商数据库
		...
		lgPayFindVder(req, res, next, condition);
	} 
		...
		condition.condPul = req.query.keyword;
		lgPayFindOrders(req, res, next, condition);
	}
		...
		lgPayFindPays(req, res, next, condition);
	}
}
lgPayFindVder = function(req, res, next, condition) {
...
lgPayFindOrders = function(req, res, next, condition) {
...
lgPayFindPays = function(req, res, next, condition) {
	Pay.count({
...
exports.pays = function(req, res) {
	...
	res.render('./sfer/lger/pay/list', list)
}
...
exports.pay = function(req, res) {
	...
	list.title = "lgPay Infomation";

	res.render('./sfer/lger/pay/detail', list)
}
