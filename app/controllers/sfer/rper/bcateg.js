...
exports.bcategs = function(req, res) {
	...
	res.render('./sfer/rper/bcateg/list', {
		title: 'Bcateg List',
...
exports.bcateg = function(req, res){
	...
	.exec(function(err, brands) {
		...
		res.render('./sfer/rper/bcateg/detail', {
...
exports.bcategPrint = function(req, res) {
	...
	.exec(function(err, brands) {
		...
		rpBcategPrintFunc(req, res, object, brands);
	})
}
rpBcategPrintFunc = function(req, res, object, brands) {
	let xl = require('excel4node');
	let wb = new xl.Workbook({
		defaultFont: {
			size: 12,
