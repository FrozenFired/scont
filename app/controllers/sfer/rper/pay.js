...
exports.paysFilter = function(req, res, next) {
	...
	if(req.query && req.query.keytype == "vder"){			// 如果是查找供应商 则先进入供应商数据库
		...
		rpPayFindVder(req, res, next, condition);
	} 
		...
		condition.condPul = req.query.keyword;
		rpPayFindOrders(req, res, next, condition);
	}
		...
		rpPayFindPays(req, res, next, condition);
	}
}
rpPayFindVder = function(req, res, next, condition) {
...
rpPayFindOrders = function(req, res, next, condition) {
...
rpPayFindPays = function(req, res, next, condition) {
	Pay.count({
...
exports.pays = function(req, res) {
	...
	res.render('./sfer/rper/pay/list', list)
}
...
exports.pay = function(req, res) {
	...
	list.title = "rpPay Infomation";

	res.render('./sfer/rper/pay/detail', list)
}
